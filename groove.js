...
<button id="marking" onclick="deleted()"><i class="fa-solid fa-xmark"></i></button>
`
...
// localStorage.setItem('pickArray', JSON.stringify(select))
}
...
// function dom(){
// let data = JSON.parse(localStorage.getItem('selectArray'))
// if (data) {
//  music=data   
// }
// }
